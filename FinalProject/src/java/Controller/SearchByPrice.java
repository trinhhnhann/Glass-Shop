...
public class SearchByPrice extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            String fromPriceStr = request.getParameter("minPrice");
            String toPriceStr = request.getParameter("maxPrice");
            ...
            if (fromPriceStr != null && toPriceStr != null && !fromPriceStr.isEmpty() && !toPriceStr.isEmpty()) {
                ...
                List<ProductInfo> listProduct = dao.getListProductByPrice(fromPrice, toPrice);
