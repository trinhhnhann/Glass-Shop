        ...
        <main>
            <div class="row clo-lg-12 int">
                <div class="col-lg-6 ima">
                    <img src="IMG/INTRO/AdminScreen.jpg" alt="Introduction Image">
                </div>
                <div class="col-lg-6 des">
                    ...
                    <p>Welcome to Enty Glasses! We believe that the right pair of glasses can not only improve your vision,
                        ...
                        you covered.</p>
                    <form action="Controller" method="post">
                        <input type="submit" name="action" value="SHOP NOW">
                    </form>
                </div>
            </div>
            <div class="row vouchers">
                ...
                <div class="col-lg-4 left">
                    <h2>HOT VOUCHER FOR USER!!! BUY NOW!!!</h2>
                    <img src="IMG/INTRO/sale.jpg" alt="Voucher"/>
                </div>
                <div class="col-lg-2"></div>
                <div class="col-lg-4 right">
                    <h1>5%</h1>
                    <p>For bill exceeds 500$</p>
                    <h1>10%</h1>
                    <p>For bill exceeds 800$</p>
                    <h1>15%</h1>
                    <p>For bill exceeds 1000$</p>
                </div>
                <div class="col-lg-1"></div>
            </div>
            <div class="features">
            ...
            <form action="Controller" method="post">
                <div class="products">
                    <div>
                        <button type="submit" name="action" value="WOMEN GLASSES">
                            <img src="IMG/INTRO/womenin.jpg" alt="Women Glasses"/>
                            <p>COLLECTIONS</p>
                            <p class="name">WOMEN GLASSES</p>
                        </button>
                    </div>
                    <div>
                        <button type="submit" name="action" value="MEN GLASSES">
                            <img src="IMG/INTRO/menin.jpg" alt="Men Glasses">
                            <p>COLLECTIONS</p>
                            <p class="name">MEN GLASSES</p>
                        </button>
                    </div>
                    <div>
                        <button type="submit" name="action" value="SUN GLASSES">
                            <img src="IMG/INTRO/sunin.jpg" alt="Sun Glasses">
                            <p>COLLECTIONS</p>
