<%-- 
    Document   : AdminError
    Created on : Jun 19, 2024, 4:24:31 AM
    Author     : nhana
--%>
...
<html>
    <head>
        ...
        <link href="CSS/AdminError.css" rel="stylesheet" type="text/css"/>
    </head>
    <body>
        ...
        <div class="tit">
            <h3 style="color:red">Your operation is not supported</h3>
            <h4>Please log in with the correct function <a href="Login.jsp">(here)</a> or return to the home page <a href="AdminScreen.jsp">(here)</a></h4>
        </div>
