<%-- 
    Document   : Thanks
    Created on : Jun 25, 2024, 4:01:55 PM
    Author     : nhana
--%>
...
<html>
    ...
    <body>
        ...
        <form action="Controller" method="post">
            <div class="thank">
                <img src="IMG/greentick.jpg"/>
                <h2>Thank you!</h2>
                <br><p>Your order was successfully completed.</p>
                <br><input type="submit" name="action" value="BACK TO SHOP"/>
            </div>
        </form>
