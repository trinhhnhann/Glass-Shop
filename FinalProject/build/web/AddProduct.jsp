<%-- 
    Document   : Addproduct
    Created on : Jun 20, 2024, 5:25:54 AM
    Author     : nhana
--%>
...
<html>
    ...
    <body>
        ...
        <form action="Controller" method="post">
            <div class="tag">
                <p>Home / Create Glasses</p>
            </div>
        </form>
        <div class="login-container">
            <h3>Create Glasses</h3>
            <form action="AddProductServlet" method="post" enctype="multipart/form-data">
                <div>
                    ID <span style="color:red">*</span><br>
                    <input type="text" placeholder="GlassID" name="userId" required/><br>

                    Name <span style="color:red">*</span><br>
                    <input type="text" placeholder="Glass Name" name="fullName" required/><br>
                ...
                <h4 style="color: red"><%= error != null ? error : ""%></h4>
            </form>
        </div>
